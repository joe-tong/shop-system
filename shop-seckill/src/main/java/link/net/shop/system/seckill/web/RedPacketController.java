package link.net.shop.system.seckill.web;
...
import link.net.shop.system.seckill.common.utils.DoubleUtil;
import link.net.shop.system.seckill.queue.delay.jvm.RedPacketMessage;
import link.net.shop.system.seckill.queue.delay.jvm.RedPacketQueue;
...
public class RedPacketController {
    ...
    public void initCache() {
         ...
         * 初始化红包数据，抢红包拦截
         */
        redisUtil.cacheValue(1 + "-num", 10000);
//        redisUtil.cacheValue(2 + "-num", 100);
//        redisUtil.cacheValue(3 + "-num", 100);
        /**
         * 初始化红包金额，单位为分
         */
        redisUtil.cacheValue(1 + "-money", 20000);
//        redisUtil.cacheValue(2 + "-money", 20000);
//        redisUtil.cacheValue(3 + "-money", 20000);
    }
    ...
    @ApiOperation(value = "真实抢红包二", nickname = "爪哇笔记")
    @PostMapping("/real/startTwo")
    public Result realStartTwo(long redPacketId, int userId) {
        redPacketId = 1;
        userId = 1;
