package link.net.shop.system.seckill.common.aop;
...
import link.net.shop.system.seckill.common.utils.IPUtils;
...
public class LimitAspect {
	...
	//Service层切点  限流
	@Pointcut("@annotation(link.net.shop.system.seckill.common.aop.ServiceLimit)")
