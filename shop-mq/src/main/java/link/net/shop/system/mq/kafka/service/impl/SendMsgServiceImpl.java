package link.net.shop.system.mq.kafka.service.impl;

import link.net.shop.system.mq.kafka.constant.RunStatus;
import link.net.shop.system.mq.kafka.constant.Topic;
import link.net.shop.system.mq.kafka.model.KafkaOutMsg;
import link.net.shop.system.mq.kafka.repository.KafkaOutMsgRepository;
import link.net.shop.system.mq.kafka.service.SendMsgService;
...
public class SendMsgServiceImpl implements SendMsgService {
    @Autowired
    private KafkaOutMsgRepository kafkaOutMsgRepository;
    /**
...
//        }
    ...
    public synchronized String getMsg2() {
        ...
        while (true) {
            ...
            KafkaOutMsg outMsg = kafkaOutMsgRepository.getOne(linkedList.getFirst());
            if (outMsg == null) {
                log.info("获取档案对象失败");
                //移除队列中数据
    ...
    public void resolve(Long fuBh) {
        ...
        kafkaOutMsgRepository.save(outMsg);
        log.info("insertOutMsg result,{}", "成功");
    }
}
